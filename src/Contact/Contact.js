...
function Contact () {
    ...
    return (
        ...
        <h3 className="contact2">Loïs</h3>
         
        <p> "J'irais graver sur vos tombes" <br/> Loïs circa 2021 </p>

        <h3 className="contact2">Jeff</h3>

        <p> "Si j'étais dans l'univers marvel, je serais un connard de l'infini" <br/> Jeff circa 2021 </p>
